...
My personal "daily-driver" deployment of ElasticStack based on original github project from [ELK-docker](https://github.com/deviantony/docker-elk).

What i changed from stock:

- Added filebeat and heartbeat directory with some confs that I normaly use
